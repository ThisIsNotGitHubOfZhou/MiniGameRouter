...
const (
	...
	RegisterService_DeRegister_FullMethodName = "/register.RegisterService/DeRegister"
)
...
func (c *registerServiceClient) DeRegister(ctx context.Context, in *DeRegisterRequest, opts ...grpc.CallOption) (*DeRegisterResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeRegisterResponse)
	err := c.cc.Invoke(ctx, RegisterService_DeRegister_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRegisterServiceServer) DeRegister(context.Context, *DeRegisterRequest) (*DeRegisterResponse, error) {
...
func _RegisterService_DeRegister_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RegisterService_DeRegister_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
